...
//           `${BASE_URL}/itinerary/tour/${tourId}`,
//           {
//             withCredentials: true,
//           }
//         );
//         const hotelResponse = await axios.get(
//           `${BASE_URL}/hotels/tour/${tourId}`,
//           {
//             withCredentials: true,
//           }
//         );
//         const restaurantResponse = await axios.get(
//           `${BASE_URL}/restaurants/tour/${tourId}`,
//           {
//             withCredentials: true,
//           }
//         );
...
//         setErrors((prev) => ({
//           ...prev,
//           guestSize: "Guest size must be at least 1.",
//         }));
//       } else {
...
//         setErrors((prev) => ({
//           ...prev,
//           bookAt: "Booking date cannot be in the past.",
//         }));
//       } else {
...
//             {" "}
//             {errors.bookAt && <small>{errors.bookAt}</small>}
//           </p>
//           <p className="text-danger">
//             {errors.guestSize && <small>{errors.guestSize}</small>}
//           </p>
//           <FormGroup>
...
//           <ListGroupItem className="border-0 px-0">
//             <h5 className="d-flex align-items-center gap-1">
//               Hotel Price: {booking.hotelPrice}{" "}
